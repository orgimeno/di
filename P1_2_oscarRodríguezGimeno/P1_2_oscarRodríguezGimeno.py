...
class MainGui:
        def __init__(self):
                ...
                "creditos_clicked_cb" : self.creditos_clicked_cb,
                "cerrarCreditos_clicked_cb" : self.cerrarCreditos_clicked_cb,
        ...
        def cerrarCreditos_clicked_cb(self, widgets):
                self.glade.get_object("credits").hide()

        def imagemenuitem10_activate_cb(self, widgets):
                self.glade.get_object("about").show_all()
                
        def creditos_clicked_cb(self, widgets):
                self.glade.get_object("credits").show_all()
